...
async function main() {
    ...
    if (!user) {
        throw new Error('No user found in database. Please run your app and signup first, or seed a user.');
    }
...
`;
    ...
    console.log('Dummy blog post created successfully with author linked!');
}
