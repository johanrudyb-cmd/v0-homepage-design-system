...
import { Loader2, CheckCircle2, Store, ExternalLink, Circle, CheckCircle, RefreshCw, Palette, Type, Code2, Copy, Check, Sparkles, ShoppingBag, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      ...
      {!isConnected ? (
        <div className="bg-gradient-to-br from-[#95BF47] to-[#5E8E3E] rounded-3xl shadow-apple-lg p-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-6">
              ...
              <div className="space-y-2 text-center lg:text-left text-white">
                <h3 className="text-3xl font-semibold tracking-tight">Créez votre boutique Shopify</h3>
        ...
        <Card className="border-2 border-green-500/30 bg-green-500/5 rounded-3xl">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div className="flex items-start gap-4 text-left">
                ...
                <div>
                  <h3 className="font-semibold text-foreground">Boutique connectée</h3>
                  <p className="text-sm text-muted-foreground">{shopifyShopDomain}</p>
                </div>
              </div>
              <Link href={`https://${shopifyShopDomain}`} target="_blank" className="text-primary hover:underline flex items-center gap-2 font-medium">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-2 px-2">
            ...
            <h3 className="text-lg font-bold">Identité pour construction</h3>
          </div>
          <Card className="rounded-3xl shadow-apple border-2">
            <CardHeader className="pb-4">
              <CardTitle className="text-base">Marque : {brand?.name}</CardTitle>
              <CardDescription>Utilisez ces réglages dans votre thème Shopify</CardDescription>
            </CardHeader>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {['primary', 'secondary', 'accent'].map((key) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="h-12 w-full rounded-xl border border-black/5 shadow-inner transition-transform group-hover:scale-95"
        ...
        <section className="space-y-6">
          ...
          <div className="flex items-center gap-2 px-2 pt-4">
            ...
            <h3 className="text-lg font-bold">Importation Directe (Auto-Build)</h3>
          </div>
          <Card className="rounded-3xl shadow-apple border-2 overflow-hidden bg-gradient-to-br from-primary/5 to-transparent">
          ...
          <div className="flex items-center gap-2 px-2 pt-4">
            ...
            <h3 className="text-lg font-bold">Paramètres de connexion</h3>
          </div>
          <Card className="rounded-3xl shadow-apple border-2">
            <CardContent className="pt-6">
