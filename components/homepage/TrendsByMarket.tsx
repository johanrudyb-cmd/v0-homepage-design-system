                  ...
                  <div className={`bg-white rounded-2xl sm:rounded-[32px] border border-[#F2F2F2] overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:shadow-apple ${isFree && !isVisible ? 'blur-sm' : ''}`}>
                    ...
                    <div className="p-4 sm:p-6 space-y-3">
                      <div>
                        ...
                        <p className="text-sm text-[#6e6e73] font-medium">{product.brand}</p>
                      </div>
                      ...
                      <button
                        ...
                        disabled={!canAnalyze}
                        className={cn(
                          'w-full px-4 py-3 rounded-full text-sm font-semibold transition-all duration-200 group-hover:scale-[1.02]',
