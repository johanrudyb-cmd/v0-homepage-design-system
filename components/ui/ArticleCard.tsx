...
export function ArticleCard({
  ...
  return (
    <article className="group relative flex flex-col overflow-hidden rounded-lg border border-border bg-card transition-all duration-200 hover:shadow-lg hover:shadow-gold/5 hover:-translate-y-1">
      {/* Image */}
