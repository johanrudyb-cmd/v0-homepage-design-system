...
export function VideoCard({
  ...
  return (
    <article className="group relative flex min-w-0 flex-col overflow-hidden rounded-lg bg-card border border-border transition-all duration-200 hover:shadow-lg hover:shadow-pink/10 hover:-translate-y-1">
      {/* Thumbnail */}
