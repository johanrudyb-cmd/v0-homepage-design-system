...
export function ProductCard({
  ...
  return (
    <article className="group relative flex flex-col overflow-hidden rounded-lg bg-card border border-border transition-all duration-200 hover:shadow-lg hover:shadow-gold/10 hover:-translate-y-1">
      {/* Image */}
