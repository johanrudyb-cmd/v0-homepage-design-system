...
export function PodcastCard({
  ...
  return (
    <article className="group relative flex min-w-0 flex-col overflow-hidden rounded-lg bg-black-light border border-white/10 transition-all duration-200 hover:border-gold/30 hover:shadow-lg hover:shadow-gold/10">
      {/* Thumbnail */}
